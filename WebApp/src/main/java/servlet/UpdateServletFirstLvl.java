...
@WebServlet("/UpdateServletFirstLvl")
public class UpdateServletFirstLvl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		firstLvlIndicatorDBBean.updateById(indicatorName, updateId, country, year, score);
