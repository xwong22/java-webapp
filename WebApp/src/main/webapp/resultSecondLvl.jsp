...
<body>
	...
	<div class="container">
	<a href="<%=request.getContextPath()%>/insertSecondLvlIndicator.jsp"><button type="button" class="btn btn-dark">新增指标</button></a>
	</div>
		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=resultsForIndicator.get(i).getCount()%></td>
					<td>
					<form
					...
					<td>
					<form
						action="<%=request.getContextPath()%>/DeleteServletSecondLvl"
						method="post">
	...
	<div class="container">
		<form action="<%=request.getContextPath()%>/SecondLvlIndicatorVizServlet"
			method="post">
			<p>国家选项（可多选）：</p>
