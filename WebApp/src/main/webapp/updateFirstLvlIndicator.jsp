...
<body>
	...
	<div class="container">
		<form action="<%=request.getContextPath()%>/UpdateServletFirstLvl"
			method="post">
			<div>
			...
			<div>
				<label for="count" class="form-label">Score</label>
				<input
					type="text" name="score" id="score" class="form-control" size=30
					value="<%=resultsForIndicator.get(0).getScore()%>">
			</div>
